...
window.driversModule = (function() {
    ...
    function updateDriverScore(driver) {
        ...
        // Correção de Pontuação: Math.round() crava o número e impede a dízima flutuante
        driver.score = Math.max(0, Math.round(score - (driver.occurrences * settings.penaltyPerOccurrence)));
