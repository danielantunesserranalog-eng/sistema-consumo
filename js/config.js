...
const MOTORISTAS_IGNORADOS = [
    ...
    'GIVANILDO DA CONCEI O URSULINO'
];
...
let dashboardData = {
    avgConsumption: 0, totalDist: 0, totalFuel: 0, avgTripsPerDay: 0, totalHistoricoTrips: 0, totalViagens: 0,
...
let importStats = {
    ...
    viagens_curtas: 0, viagens_consolidadas_salvas: 0, erros: 0, ignored_not_serrana: 0
};
